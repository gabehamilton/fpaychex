...
<head>
	...
	<title>Paychex Replacement</title>
	<style type="text/css">
	@import "http://ajax.googleapis.com/ajax/libs/dojo/1.8.3/dojox/calendar/themes/claro/Calendar.css";
	@import "css/calendar.css";
	@import "http://ajax.googleapis.com/ajax/libs/dojo/1.8.3/dojo/resources/dojo.css";
	@import "http://ajax.googleapis.com/ajax/libs/dojo/1.8.3/dijit/themes/dijit.css";
	@import "http://ajax.googleapis.com/ajax/libs/dojo/1.8.3/dijit/themes/claro/claro.css";
	</style>
	<script type="text/javascript">
		var users = ${users as JSON};
		var timeOffs = ${timeOffs as JSON};
	</script>
	<script type="text/javascript"
...
<div data-dojo-type="dijit.layout.BorderContainer" style="width:100%;height:100%" data-dojo-props="design:'sidebar', gutters:true" >
	<div data-dojo-type="dijit.layout.ContentPane" style="width:200px" data-dojo-props="splitter:false, region:'leading'">
		...
		<div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'Calendars', style:'margin-top:10px;'" >
			<div>
				<input type="checkbox" id="calendar1CB" data-dojo-id="calendar1CB" data-dojo-type="dijit.form.CheckBox" checked="true"/>
				<label for="calendar1CB">Mikkel Garcia</label>
			</div>

			<div style="margin-top:5px">
				<input type="checkbox" id="calendar2CB" data-dojo-id="calendar2CB" data-dojo-type="dijit.form.CheckBox" checked="true"/>
				<label for="calendar2CB">Gabe Hamilton</label>
			</div>
		</div>
		<div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'Event properties', style:'margin-top:10px;'" >
			...
			<select data-dojo-id="calendarEditor" data-dojo-type="dijit.form.ComboBox"  style="width:165px;" data-dojo-props="disabled:true" >
				<option>Mikkel Garcia</option>
				<option>Gabe Hamilton</option>
			</select>
			<div style="margin-top:10px">
				<input type="checkbox" id="allDayCB" data-dojo-id="allDayCB" data-dojo-type="dijit.form.CheckBox" checked="false" data-dojo-props="disabled:true" />
